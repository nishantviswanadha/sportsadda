<?php  session_start();    $_SESSION['CHECK']='you';    ?>
...
<body>
 ...
 <p style='font-size:20px;width:1200px; margin-left:600px;padding-top:150px;padding-bottom:150px'>YOU HAVE SUCCESSFULLY LOGGED OUT !! </p>
