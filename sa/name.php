...
<body>
  ...
  Enter your new Name.: <input type="text" name="name">
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!preg_match("/^[a-zA-Z][a-zA-Z ]{2,}/",$_POST["name"])) {
...
echo" YOUR NAME HAS BEEN UPDATED SUCCESSFULLY CLICK HERE TO GO BACK <a href='1.php'> GO BACK </a>";
