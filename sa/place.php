...
<body>
  ...
  Enter your new Place.: <input type="text" name="name">
...
$collection->update(array("username"=> $_SESSION["favo"]), 
      array('$set'=>array("place"=>$_POST['name'])));
echo" YOUR PLACE HAS BEEN UPDATED SUCCESSFULLY CLICK HERE TO GO BACK <a href='1.php'> GO BACK </a>";
