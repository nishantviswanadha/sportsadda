...
<body>
  ...
  Enter your new Contact No.: <input type="text" name="name">
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!preg_match("/^[789][0-9]{9}/",$_POST["name"])) {
      echo "Not a valid mobile no."; 
    }
...
$collection->update(array("username"=> $_SESSION["favo"]), 
      array('$set'=>array("contact"=>$_POST['name'])));
echo" YOUR CONTACT NO. HAS BEEN UPDATED SUCCESSFULLY CLICK HERE TO GO BACK <a href='1.php'> GO BACK </a>";
