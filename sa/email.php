...
<body>
  ...
  Enter your new E-mail: <input type="text" name="name">
...
$collection->update(array("username"=> $_SESSION["favo"]), 
      array('$set'=>array("email"=>$_POST['name'])));
echo" YOUR E-MAIL HAS BEEN UPDATED SUCCESSFULLY CLICK HERE TO GO BACK <a href='1.php'> GO BACK </a>";
