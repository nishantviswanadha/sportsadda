...
<body>
	...
	<!-- YAHA SE SHURU-->
	<?php echo"<div style=\"background-color:#dc4c46;\"><br><h1 style=\" text-align:center;\"><b>Football News</b></h1><br><div style=\"background-color:rgb(230,230,230);border:solid grey 2px;border-radius:50px;width:1000px; margin:0 auto;\">";
	$sportNewsTxt = file_get_contents('https://newsapi.org/v1/articles?source=football-italia&sortBy=latest&apiKey=9f951101e7954c349e053ea63c2cd820');	// change with your API key
