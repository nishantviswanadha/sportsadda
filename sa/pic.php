...
<body>
  ...
  Upload you new Profile picture: <input type="file" name="fileToUpload">
...
$collection->update(array("username"=> $_SESSION["favo"]), 
      array('$set'=>array("pic"=>$target_file)));
echo" YOUR PROFILE PICTURE HAS BEEN UPDATED SUCCESSFULLY CLICK HERE TO GO BACK <a href='profile.php'> GO BACK </a>";
